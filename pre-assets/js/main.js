    ...
    $(document).on('ready', function () {
        ...
        function backgroundImageInit() {
            ...
            $('header, #testimonials').each(function () {
                if ($(this).attr('data-image-bg') && $(this).attr('data-gradient-overlay-one') && $(this).attr('data-gradient-overlay-two')) {

                    //hide in retina
                    $(this).css({
                        'background': 'linear-gradient(' + $(this).data('gradient-overlay-one') + ',' + $(this).data('gradient-overlay-two') + '), url(' + $(this).data('image-bg') + ') center center / cover no-repeat',
